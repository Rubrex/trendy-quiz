    ...
    <div className="border-bottom-shadow">
      <div className="px-4 py-5 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 ">
        <div className="relative flex items-center justify-between">
          <Link
            to="/"
            aria-label=" Trendy Quiz"
            title="Trendy Quiz"
            className="inline-flex items-center"
          >
            <img src={logo} width="50" alt="" />
            <span className="ml-2 text-xl font-bold tracking-wide text-gray-800 uppercase mt-1">
              Trendy Quiz
            </span>
          </Link>
          ...
          <div className="lg:hidden">
            ...
            {isMenuOpen && (
              <div className="absolute top-0 left-0 w-full">
                <div className="p-5 bg-white border rounded shadow-sm z-50 relative">
